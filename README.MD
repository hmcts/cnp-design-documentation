...
Use Semantic versioning to publish a TerraService in the CI pipeline automatically when tests have passed. Tag a release, and point the *latest* tag to the latest release.
